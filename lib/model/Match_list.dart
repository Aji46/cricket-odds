...
//
//     final cricketApiResponse = cricketApiResponseFromJson(jsonString);

import 'dart:convert';

List<CricketApiResponse> cricketApiResponseFromJson(String str) => List<CricketApiResponse>.from(json.decode(str).map((x) => CricketApiResponse.fromJson(x)));

String cricketApiResponseToJson(List<CricketApiResponse> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
...
class CricketApiResponse {
    ...
    factory CricketApiResponse.fromJson(Map<String, dynamic> json) => CricketApiResponse(
        id: json["id"],
        name: json["name"],
        ...
        homeTeamScore: TeamScore.fromJson(json["home_team_score"]),
        awayTeamScore: TeamScore.fromJson(json["away_team_score"]),
